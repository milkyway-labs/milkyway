...
import (
	...
	addressutil "github.com/milkyway-labs/milkyway/v11/pkg/address"
)
...
func AddBech32ConvertCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Convert any bech32 string to the MilkyWay prefix",
		Long: `Convert any bech32 string to the MilkyWay prefix

Example:
	milkywayd debug bech32-convert akash1a6zlyvpnksx8wr6wz8wemur2xe8zyh0ytz6d88

	milkywayd debug bech32-convert stride1673f0t8p893rqyqe420mgwwz92ac4qv6synvx2 --prefix osmo
	`,
