...
import (
	...
	"github.com/milkyway-labs/milkyway/v8/ante"
	"github.com/milkyway-labs/milkyway/v8/app/sim"

	milkyway "github.com/milkyway-labs/milkyway/v8/app"
)

// AppChainID hardcoded chainID for simulation
const AppChainID = "milkyway-app"
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numSeeds; i++ {
		...
		for j := 0; j < numTimesToRunPerSeed; j++ {
			...
			db := dbm.NewMemDB()
			dir, err := os.MkdirTemp("", "milkyway-simulation")
