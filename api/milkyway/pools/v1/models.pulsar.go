...
var (
	...
	fd_Pool_tokens           protoreflect.FieldDescriptor
	fd_Pool_delegator_shares protoreflect.FieldDescriptor
)

func init() {
	file_milkyway_pools_v1_models_proto_init()
	md_Pool = File_milkyway_pools_v1_models_proto.Messages().ByName("Pool")
	...
	fd_Pool_tokens = md_Pool.Fields().ByName("tokens")
	fd_Pool_delegator_shares = md_Pool.Fields().ByName("delegator_shares")
}
...
func (x *Pool) slowProtoReflect() protoreflect.Message {
	mi := &file_milkyway_pools_v1_models_proto_msgTypes[0]
...
func (x *fastReflection_Pool) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "milkyway.pools.v1.Pool.id":
		return x.Id != uint32(0)
	case "milkyway.pools.v1.Pool.denom":
		return x.Denom != ""
	case "milkyway.pools.v1.Pool.address":
		return x.Address != ""
	case "milkyway.pools.v1.Pool.tokens":
		return x.Tokens != ""
	case "milkyway.pools.v1.Pool.delegator_shares":
		return x.DelegatorShares != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.pools.v1.Pool"))
		}
		panic(fmt.Errorf("message milkyway.pools.v1.Pool does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pool) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message milkyway.pools.v1.Pool does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.pools.v1.Pool.id":
		panic(fmt.Errorf("field id of message milkyway.pools.v1.Pool is not mutable"))
	case "milkyway.pools.v1.Pool.denom":
		panic(fmt.Errorf("field denom of message milkyway.pools.v1.Pool is not mutable"))
	case "milkyway.pools.v1.Pool.address":
		panic(fmt.Errorf("field address of message milkyway.pools.v1.Pool is not mutable"))
	case "milkyway.pools.v1.Pool.tokens":
		panic(fmt.Errorf("field tokens of message milkyway.pools.v1.Pool is not mutable"))
	case "milkyway.pools.v1.Pool.delegator_shares":
		panic(fmt.Errorf("field delegator_shares of message milkyway.pools.v1.Pool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.pools.v1.Pool"))
		}
...
func (x *fastReflection_Pool) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in milkyway.pools.v1.Pool", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Pool) Descriptor() ([]byte, []int) {
	return file_milkyway_pools_v1_models_proto_rawDescGZIP(), []int{0}
}
...
var file_milkyway_pools_v1_models_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x02, 0x0a, 0x04, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x16, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x42, 0x06, 0xe2, 0xde, 0x1f, 0x02, 0x49,
	0x44, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x02,
	...
	0x43, 0x0a, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42,
	...
	0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x06, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x73, 0x12, 0x5c, 0x0a, 0x10, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x6f,
	0x72, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31,
	...
	0x65, 0x73, 0x42, 0xcb, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x69, 0x6c, 0x6b, 0x79,
	0x77, 0x61, 0x79, 0x2e, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x4d, 0x6f,
	...
	,
}

var (
	file_milkyway_pools_v1_models_proto_rawDescOnce sync.Once
	file_milkyway_pools_v1_models_proto_rawDescData = file_milkyway_pools_v1_models_proto_rawDesc
)

func file_milkyway_pools_v1_models_proto_rawDescGZIP() []byte {
	file_milkyway_pools_v1_models_proto_rawDescOnce.Do(func() {
		file_milkyway_pools_v1_models_proto_rawDescData = protoimpl.X.CompressGZIP(file_milkyway_pools_v1_models_proto_rawDescData)
	})
	return file_milkyway_pools_v1_models_proto_rawDescData
}

var file_milkyway_pools_v1_models_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_milkyway_pools_v1_models_proto_goTypes = []interface{}{
	(*Pool)(nil), // 0: milkyway.pools.v1.Pool
}
var file_milkyway_pools_v1_models_proto_depIdxs = []int32{
...
func init() { file_milkyway_pools_v1_models_proto_init() }
func file_milkyway_pools_v1_models_proto_init() {
	if File_milkyway_pools_v1_models_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_milkyway_pools_v1_models_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pool); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_milkyway_pools_v1_models_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_milkyway_pools_v1_models_proto_goTypes,
		DependencyIndexes: file_milkyway_pools_v1_models_proto_depIdxs,
		MessageInfos:      file_milkyway_pools_v1_models_proto_msgTypes,
	}.Build()
	File_milkyway_pools_v1_models_proto = out.File
	file_milkyway_pools_v1_models_proto_rawDesc = nil
	file_milkyway_pools_v1_models_proto_goTypes = nil
	file_milkyway_pools_v1_models_proto_depIdxs = nil
}
