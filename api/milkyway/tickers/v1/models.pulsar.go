...
func init() {
	...
	md_Asset = File_milkyway_tickers_v1_models_proto.Messages().ByName("Asset")
...
func (x *Asset) slowProtoReflect() protoreflect.Message {
	mi := &file_milkyway_tickers_v1_models_proto_msgTypes[0]
...
func (x *fastReflection_Asset) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "milkyway.tickers.v1.Asset.denom":
		return x.Denom != ""
	case "milkyway.tickers.v1.Asset.ticker":
		return x.Ticker != ""
	case "milkyway.tickers.v1.Asset.exponent":
		return x.Exponent != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.tickers.v1.Asset"))
		}
		panic(fmt.Errorf("message milkyway.tickers.v1.Asset does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Asset) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message milkyway.tickers.v1.Asset does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Asset) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.tickers.v1.Asset.denom":
		panic(fmt.Errorf("field denom of message milkyway.tickers.v1.Asset is not mutable"))
	case "milkyway.tickers.v1.Asset.ticker":
		panic(fmt.Errorf("field ticker of message milkyway.tickers.v1.Asset is not mutable"))
	case "milkyway.tickers.v1.Asset.exponent":
		panic(fmt.Errorf("field exponent of message milkyway.tickers.v1.Asset is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.tickers.v1.Asset"))
		}
...
func (x *fastReflection_Asset) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in milkyway.tickers.v1.Asset", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Asset) Descriptor() ([]byte, []int) {
	return file_milkyway_tickers_v1_models_proto_rawDescGZIP(), []int{0}
}
...
var File_milkyway_tickers_v1_models_proto protoreflect.FileDescriptor

var file_milkyway_tickers_v1_models_proto_rawDesc = []byte{
	0x0a, 0x20, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2f, 0x74, 0x69, 0x63, 0x6b, 0x65,
	0x72, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x13, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x69, 0x63,
	0x6b, 0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x51, 0x0a,
	...
	0x63, 0x6b, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x42, 0xdd, 0x01, 0xc8, 0xe1, 0x1e, 0x00, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x69, 0x6c,
	...
	,
}

var (
	file_milkyway_tickers_v1_models_proto_rawDescOnce sync.Once
	file_milkyway_tickers_v1_models_proto_rawDescData = file_milkyway_tickers_v1_models_proto_rawDesc
)

func file_milkyway_tickers_v1_models_proto_rawDescGZIP() []byte {
	file_milkyway_tickers_v1_models_proto_rawDescOnce.Do(func() {
		file_milkyway_tickers_v1_models_proto_rawDescData = protoimpl.X.CompressGZIP(file_milkyway_tickers_v1_models_proto_rawDescData)
	})
	return file_milkyway_tickers_v1_models_proto_rawDescData
}

var file_milkyway_tickers_v1_models_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_milkyway_tickers_v1_models_proto_goTypes = []interface{}{
	(*Asset)(nil), // 0: milkyway.tickers.v1.Asset
}
var file_milkyway_tickers_v1_models_proto_depIdxs = []int32{
...
func init() { file_milkyway_tickers_v1_models_proto_init() }
func file_milkyway_tickers_v1_models_proto_init() {
	if File_milkyway_tickers_v1_models_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_milkyway_tickers_v1_models_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Asset); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_milkyway_tickers_v1_models_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_milkyway_tickers_v1_models_proto_goTypes,
		DependencyIndexes: file_milkyway_tickers_v1_models_proto_depIdxs,
		MessageInfos:      file_milkyway_tickers_v1_models_proto_msgTypes,
	}.Build()
	File_milkyway_tickers_v1_models_proto = out.File
	file_milkyway_tickers_v1_models_proto_rawDesc = nil
	file_milkyway_tickers_v1_models_proto_goTypes = nil
	file_milkyway_tickers_v1_models_proto_depIdxs = nil
}
