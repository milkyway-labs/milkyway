...
func init() {
	...
	md_DenomAuthorityMetadata = File_milkyway_tokenfactory_v1_authority_metadata_proto.Messages().ByName("DenomAuthorityMetadata")
...
func (x *DenomAuthorityMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_milkyway_tokenfactory_v1_authority_metadata_proto_msgTypes[0]
...
// 	protoc        (unknown)
// source: milkyway/tokenfactory/v1/authority_metadata.proto
...
func (*DenomAuthorityMetadata) Descriptor() ([]byte, []int) {
	return file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescGZIP(), []int{0}
}
...
var File_milkyway_tokenfactory_v1_authority_metadata_proto protoreflect.FileDescriptor

var file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDesc = []byte{
	0x0a, 0x31, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x42, 0x87, 0x02, 0x0a, 0x1c,
...
var (
	file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescOnce sync.Once
	file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescData = file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDesc
)

func file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescGZIP() []byte {
	file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescOnce.Do(func() {
		file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescData)
	})
	return file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDescData
}

var file_milkyway_tokenfactory_v1_authority_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_milkyway_tokenfactory_v1_authority_metadata_proto_goTypes = []interface{}{
	(*DenomAuthorityMetadata)(nil), // 0: milkyway.tokenfactory.v1.DenomAuthorityMetadata
}
var file_milkyway_tokenfactory_v1_authority_metadata_proto_depIdxs = []int32{
...
func init() { file_milkyway_tokenfactory_v1_authority_metadata_proto_init() }
func file_milkyway_tokenfactory_v1_authority_metadata_proto_init() {
	if File_milkyway_tokenfactory_v1_authority_metadata_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_milkyway_tokenfactory_v1_authority_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_milkyway_tokenfactory_v1_authority_metadata_proto_goTypes,
		DependencyIndexes: file_milkyway_tokenfactory_v1_authority_metadata_proto_depIdxs,
		MessageInfos:      file_milkyway_tokenfactory_v1_authority_metadata_proto_msgTypes,
	}.Build()
	File_milkyway_tokenfactory_v1_authority_metadata_proto = out.File
	file_milkyway_tokenfactory_v1_authority_metadata_proto_rawDesc = nil
	file_milkyway_tokenfactory_v1_authority_metadata_proto_goTypes = nil
	file_milkyway_tokenfactory_v1_authority_metadata_proto_depIdxs = nil
}
