...
func init() {
	...
	md_DenomAuthorityMetadata = File_milkyway_tokenfactory_v1_authorityMetadata_proto.Messages().ByName("DenomAuthorityMetadata")
...
func (x *DenomAuthorityMetadata) slowProtoReflect() protoreflect.Message {
	mi := &file_milkyway_tokenfactory_v1_authorityMetadata_proto_msgTypes[0]
...
func (x *fastReflection_DenomAuthorityMetadata) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "milkyway.tokenfactory.v1.DenomAuthorityMetadata.admin":
		return x.Admin != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.tokenfactory.v1.DenomAuthorityMetadata"))
		}
		panic(fmt.Errorf("message milkyway.tokenfactory.v1.DenomAuthorityMetadata does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DenomAuthorityMetadata) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message milkyway.tokenfactory.v1.DenomAuthorityMetadata does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DenomAuthorityMetadata) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.tokenfactory.v1.DenomAuthorityMetadata.admin":
		panic(fmt.Errorf("field admin of message milkyway.tokenfactory.v1.DenomAuthorityMetadata is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.tokenfactory.v1.DenomAuthorityMetadata"))
		}
...
func (x *fastReflection_DenomAuthorityMetadata) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in milkyway.tokenfactory.v1.DenomAuthorityMetadata", d.FullName()))
	}
	panic("unreachable")
}
...
func (*DenomAuthorityMetadata) Descriptor() ([]byte, []int) {
	return file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescGZIP(), []int{0}
}
...
var File_milkyway_tokenfactory_v1_authorityMetadata_proto protoreflect.FileDescriptor

var file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDesc = []byte{
	0x0a, 0x30, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x74, 0x6f, 0x12, 0x18, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x6f, 0x6b,
	...
	,
...
var (
	file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescOnce sync.Once
	file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescData = file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDesc
)

func file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescGZIP() []byte {
	file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescOnce.Do(func() {
		file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescData = protoimpl.X.CompressGZIP(file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescData)
	})
	return file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDescData
}

var file_milkyway_tokenfactory_v1_authorityMetadata_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_milkyway_tokenfactory_v1_authorityMetadata_proto_goTypes = []interface{}{
	(*DenomAuthorityMetadata)(nil), // 0: milkyway.tokenfactory.v1.DenomAuthorityMetadata
}
var file_milkyway_tokenfactory_v1_authorityMetadata_proto_depIdxs = []int32{
...
func init() { file_milkyway_tokenfactory_v1_authorityMetadata_proto_init() }
func file_milkyway_tokenfactory_v1_authorityMetadata_proto_init() {
	if File_milkyway_tokenfactory_v1_authorityMetadata_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_milkyway_tokenfactory_v1_authorityMetadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_milkyway_tokenfactory_v1_authorityMetadata_proto_goTypes,
		DependencyIndexes: file_milkyway_tokenfactory_v1_authorityMetadata_proto_depIdxs,
		MessageInfos:      file_milkyway_tokenfactory_v1_authorityMetadata_proto_msgTypes,
	}.Build()
	File_milkyway_tokenfactory_v1_authorityMetadata_proto = out.File
	file_milkyway_tokenfactory_v1_authorityMetadata_proto_rawDesc = nil
	file_milkyway_tokenfactory_v1_authorityMetadata_proto_goTypes = nil
	file_milkyway_tokenfactory_v1_authorityMetadata_proto_depIdxs = nil
}
