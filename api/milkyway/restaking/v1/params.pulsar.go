...
var (
	...
	fd_Params_restaking_cap  protoreflect.FieldDescriptor
	fd_Params_max_entries    protoreflect.FieldDescriptor
)

func init() {
	file_milkyway_restaking_v1_params_proto_init()
	md_Params = File_milkyway_restaking_v1_params_proto.Messages().ByName("Params")
	...
	fd_Params_restaking_cap = md_Params.Fields().ByName("restaking_cap")
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_milkyway_restaking_v1_params_proto_msgTypes[0]
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.UnbondingTime != int64(0) {
		value := protoreflect.ValueOfInt64(x.UnbondingTime)
	...
	if x.RestakingCap != "" {
		value := protoreflect.ValueOfString(x.RestakingCap)
		if !f(fd_Params_restaking_cap, value) {
			return
		}
	}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "milkyway.restaking.v1.Params.unbonding_time":
		return x.UnbondingTime != int64(0)
	case "milkyway.restaking.v1.Params.allowed_denoms":
		return len(x.AllowedDenoms) != 0
	case "milkyway.restaking.v1.Params.restaking_cap":
		return x.RestakingCap != ""
	case "milkyway.restaking.v1.Params.max_entries":
		return x.MaxEntries != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.Params"))
		}
		panic(fmt.Errorf("message milkyway.restaking.v1.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message milkyway.restaking.v1.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "milkyway.restaking.v1.Params.unbonding_time":
		x.UnbondingTime = value.Int()
	case "milkyway.restaking.v1.Params.allowed_denoms":
		lv := value.List()
		clv := lv.(*_Params_2_list)
		x.AllowedDenoms = *clv.list
	case "milkyway.restaking.v1.Params.restaking_cap":
		x.RestakingCap = value.Interface().(string)
	case "milkyway.restaking.v1.Params.max_entries":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "milkyway.restaking.v1.Params.unbonding_time":
		panic(fmt.Errorf("field unbonding_time of message milkyway.restaking.v1.Params is not mutable"))
	case "milkyway.restaking.v1.Params.restaking_cap":
		panic(fmt.Errorf("field restaking_cap of message milkyway.restaking.v1.Params is not mutable"))
	case "milkyway.restaking.v1.Params.max_entries":
		panic(fmt.Errorf("field max_entries of message milkyway.restaking.v1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.Params"))
		}
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in milkyway.restaking.v1.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.RestakingCap) > 0 {
			i -= len(x.RestakingCap)
			copy(dAtA[i:], x.RestakingCap)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.RestakingCap)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.AllowedDenoms) > 0 {
		...
		for iNdEx < l {
			...
			case 1:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.UnbondingTime |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RestakingCap", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.RestakingCap = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 4:
				if wireType != 0 {
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_milkyway_restaking_v1_params_proto_rawDescGZIP(), []int{0}
}

func (x *Params) GetUnbondingTime() int64 {
	if x != nil {
...
func (x *Params) GetRestakingCap() string {
	if x != nil {
		return x.RestakingCap
	}
	return ""
...
var File_milkyway_restaking_v1_params_proto protoreflect.FileDescriptor

var file_milkyway_restaking_v1_params_proto_rawDesc = []byte{
	0x0a, 0x22, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x61,
	0x6b, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x15, 0x6d, 0x69, 0x6c, 0x6b, 0x79, 0x77, 0x61, 0x79, 0x2e, 0x72,
	0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x1a, 0x19, 0x63, 0x6f, 0x73,
	...
	0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x2b, 0x0a, 0x0e, 0x75, 0x6e, 0x62, 0x6f, 0x6e,
	0x64, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x42,
	0x04, 0x98, 0xdf, 0x1f, 0x01, 0x52, 0x0d, 0x75, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f,
	0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0d, 0x61, 0x6c,
	0x6c, 0x6f, 0x77, 0x65, 0x64, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x73, 0x12, 0x56, 0x0a, 0x0d, 0x72,
	0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x61, 0x70, 0x18, 0x03, 0x20, 0x01,
	...
	0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67,
	0x43, 0x61, 0x70, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x61, 0x78, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x69,
	0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x45, 0x6e, 0x74,
	0x72, 0x69, 0x65, 0x73, 0x42, 0xea, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x69, 0x6c,
	...
	0x01, 0x5a, 0x4a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x69,
...
var (
	file_milkyway_restaking_v1_params_proto_rawDescOnce sync.Once
	file_milkyway_restaking_v1_params_proto_rawDescData = file_milkyway_restaking_v1_params_proto_rawDesc
)

func file_milkyway_restaking_v1_params_proto_rawDescGZIP() []byte {
	file_milkyway_restaking_v1_params_proto_rawDescOnce.Do(func() {
		file_milkyway_restaking_v1_params_proto_rawDescData = protoimpl.X.CompressGZIP(file_milkyway_restaking_v1_params_proto_rawDescData)
	})
	return file_milkyway_restaking_v1_params_proto_rawDescData
}

var file_milkyway_restaking_v1_params_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_milkyway_restaking_v1_params_proto_goTypes = []interface{}{
	(*Params)(nil), // 0: milkyway.restaking.v1.Params
}
var file_milkyway_restaking_v1_params_proto_depIdxs = []int32{
...
func init() { file_milkyway_restaking_v1_params_proto_init() }
func file_milkyway_restaking_v1_params_proto_init() {
	if File_milkyway_restaking_v1_params_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_milkyway_restaking_v1_params_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_milkyway_restaking_v1_params_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_milkyway_restaking_v1_params_proto_goTypes,
		DependencyIndexes: file_milkyway_restaking_v1_params_proto_depIdxs,
		MessageInfos:      file_milkyway_restaking_v1_params_proto_msgTypes,
	}.Build()
	File_milkyway_restaking_v1_params_proto = out.File
	file_milkyway_restaking_v1_params_proto_rawDesc = nil
	file_milkyway_restaking_v1_params_proto_goTypes = nil
	file_milkyway_restaking_v1_params_proto_depIdxs = nil
}
