...
var _ protoreflect.List = (*_OperatorSecuredServices_1_list)(nil)

type _OperatorSecuredServices_1_list struct {
	list *[]uint32
}

func (x *_OperatorSecuredServices_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_OperatorSecuredServices_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfUint32((*x.list)[i])
}

func (x *_OperatorSecuredServices_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Uint()
	concreteValue := (uint32)(valueUnwrapped)
	(*x.list)[i] = concreteValue
}

func (x *_OperatorSecuredServices_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Uint()
	concreteValue := (uint32)(valueUnwrapped)
	*x.list = append(*x.list, concreteValue)
}

func (x *_OperatorSecuredServices_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message OperatorSecuredServices at list field ServiceIds as it is not of Message kind"))
}

func (x *_OperatorSecuredServices_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_OperatorSecuredServices_1_list) NewElement() protoreflect.Value {
	v := uint32(0)
	return protoreflect.ValueOfUint32(v)
}

func (x *_OperatorSecuredServices_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_OperatorSecuredServices             protoreflect.MessageDescriptor
	fd_OperatorSecuredServices_service_ids protoreflect.FieldDescriptor
)

func init() {
	file_milkyway_restaking_v1_models_proto_init()
	md_OperatorSecuredServices = File_milkyway_restaking_v1_models_proto.Messages().ByName("OperatorSecuredServices")
	fd_OperatorSecuredServices_service_ids = md_OperatorSecuredServices.Fields().ByName("service_ids")
}

var _ protoreflect.Message = (*fastReflection_OperatorSecuredServices)(nil)

type fastReflection_OperatorSecuredServices OperatorSecuredServices

func (x *OperatorSecuredServices) ProtoReflect() protoreflect.Message {
	return (*fastReflection_OperatorSecuredServices)(x)
}

func (x *OperatorSecuredServices) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_OperatorSecuredServices_messageType fastReflection_OperatorSecuredServices_messageType
var _ protoreflect.MessageType = fastReflection_OperatorSecuredServices_messageType{}

type fastReflection_OperatorSecuredServices_messageType struct{}

func (x fastReflection_OperatorSecuredServices_messageType) Zero() protoreflect.Message {
	return (*fastReflection_OperatorSecuredServices)(nil)
}
func (x fastReflection_OperatorSecuredServices_messageType) New() protoreflect.Message {
	return new(fastReflection_OperatorSecuredServices)
}
func (x fastReflection_OperatorSecuredServices_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_OperatorSecuredServices
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_OperatorSecuredServices) Descriptor() protoreflect.MessageDescriptor {
	return md_OperatorSecuredServices
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_OperatorSecuredServices) Type() protoreflect.MessageType {
	return _fastReflection_OperatorSecuredServices_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_OperatorSecuredServices) New() protoreflect.Message {
	return new(fastReflection_OperatorSecuredServices)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_OperatorSecuredServices) Interface() protoreflect.ProtoMessage {
	return (*OperatorSecuredServices)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_OperatorSecuredServices) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.ServiceIds) != 0 {
		value := protoreflect.ValueOfList(&_OperatorSecuredServices_1_list{list: &x.ServiceIds})
		if !f(fd_OperatorSecuredServices_service_ids, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_OperatorSecuredServices) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "milkyway.restaking.v1.OperatorSecuredServices.service_ids":
		return len(x.ServiceIds) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.OperatorSecuredServices"))
		}
		panic(fmt.Errorf("message milkyway.restaking.v1.OperatorSecuredServices does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OperatorSecuredServices) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "milkyway.restaking.v1.OperatorSecuredServices.service_ids":
		x.ServiceIds = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_OperatorSecuredServices) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "milkyway.restaking.v1.OperatorSecuredServices.service_ids":
		if len(x.ServiceIds) == 0 {
			return protoreflect.ValueOfList(&_OperatorSecuredServices_1_list{})
		}
		listValue := &_OperatorSecuredServices_1_list{list: &x.ServiceIds}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.OperatorSecuredServices"))
		}
		panic(fmt.Errorf("message milkyway.restaking.v1.OperatorSecuredServices does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OperatorSecuredServices) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "milkyway.restaking.v1.OperatorSecuredServices.service_ids":
		lv := value.List()
		clv := lv.(*_OperatorSecuredServices_1_list)
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OperatorSecuredServices) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.restaking.v1.OperatorSecuredServices.service_ids":
		if x.ServiceIds == nil {
			x.ServiceIds = []uint32{}
		}
		value := &_OperatorSecuredServices_1_list{list: &x.ServiceIds}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.OperatorSecuredServices"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_OperatorSecuredServices) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.restaking.v1.OperatorSecuredServices.service_ids":
		list := []uint32{}
		return protoreflect.ValueOfList(&_OperatorSecuredServices_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.OperatorSecuredServices"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_OperatorSecuredServices) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in milkyway.restaking.v1.OperatorSecuredServices", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_OperatorSecuredServices) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OperatorSecuredServices) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_OperatorSecuredServices) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_OperatorSecuredServices) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*OperatorSecuredServices)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: OperatorSecuredServices: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: OperatorSecuredServices: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType == 0 {
...
// OperatorSecuredServices represent the list of services that an operator is
// securing.
type OperatorSecuredServices struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ServiceIDs defines the list of service IDs that the operator is securing.
	ServiceIds []uint32 `protobuf:"varint,1,rep,packed,name=service_ids,json=serviceIds,proto3" json:"service_ids,omitempty"`
}

func (x *OperatorSecuredServices) Reset() {
	*x = OperatorSecuredServices{}
	if protoimpl.UnsafeEnabled {
		mi := &file_milkyway_restaking_v1_models_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *OperatorSecuredServices) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OperatorSecuredServices) ProtoMessage() {}

// Deprecated: Use OperatorSecuredServices.ProtoReflect.Descriptor instead.
func (*OperatorSecuredServices) Descriptor() ([]byte, []int) {
	return file_milkyway_restaking_v1_models_proto_rawDescGZIP(), []int{1}
}

func (x *OperatorSecuredServices) GetServiceIds() []uint32 {
	if x != nil {
		return x.ServiceIds
	}
	return nil
...
var file_milkyway_restaking_v1_models_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x49, 0x64, 0x73, 0x22, 0x4a, 0x0a, 0x17, 0x4f, 0x70,
	0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x63, 0x75, 0x72, 0x65, 0x64, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x2f, 0x0a, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x5f, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x42, 0x0e, 0xe2, 0xde, 0x1f, 0x0a,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x44, 0x73, 0x52, 0x0a, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x49, 0x64, 0x73, 0x22, 0x81, 0x02, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x4a, 0x0a, 0x0e, 0x73, 0x6c, 0x61, 0x73,
	...
	,
	...
	0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x12, 0x3b, 0x0a, 0x0c, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xd2, 0xb4, 0x2d, 0x14,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x52, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	...
	0x49, 0x44, 0x52, 0x08, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x49, 0x64, 0x12, 0x69, 0x0a, 0x06,
	0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63,
	...
	,
	...
	0x6f, 0x69, 0x6e, 0x73, 0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x3a, 0x04, 0xe8,
	0xa0, 0x1f, 0x00, 0x22, 0xa2, 0x02, 0x0a, 0x13, 0x55, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e,
	0x67, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x39, 0x0a, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x6d, 0x69, 0x6c, 0x6b,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x45, 0x0a, 0x11, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61,
	...
	0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x29, 0x0a,
	0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x42, 0x0c, 0xe2, 0xde, 0x1f, 0x08, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x49, 0x44, 0x52, 0x08,
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x49, 0x64, 0x12, 0x54, 0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72,
	0x69, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x6d, 0x69, 0x6c, 0x6b,
	0x79, 0x77, 0x61, 0x79, 0x2e, 0x72, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76,
	...
	0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x3a, 0x08,
	0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xae, 0x03, 0x0a, 0x18, 0x55, 0x6e, 0x62,
	...
	0x6d, 0x65, 0x12, 0x74, 0x0a, 0x0f, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x62, 0x61,
	0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f,
	...
	0x65, 0x73, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x0e, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61,
	0x6c, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x65, 0x0a, 0x07, 0x62, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	...
	,
	...
	,
	...
	0x45, 0x52, 0x56, 0x49, 0x43, 0x45, 0x10, 0x03, 0x1a, 0x04, 0x88, 0xa3, 0x1e, 0x00, 0x42, 0xe7,
	...
	0x64, 0x65, 0x6c, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x47, 0x67, 0x69, 0x74,
...
var file_milkyway_restaking_v1_models_proto_goTypes = []interface{}{
	...
	(*OperatorSecuredServices)(nil),  // 2: milkyway.restaking.v1.OperatorSecuredServices
...
func file_milkyway_restaking_v1_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_milkyway_restaking_v1_models_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OperatorSecuredServices); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
