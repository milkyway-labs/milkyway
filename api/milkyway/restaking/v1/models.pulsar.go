...
var _ protoreflect.List = (*_TotalRestakedAssets_1_list)(nil)

type _TotalRestakedAssets_1_list struct {
	list *[]*v1beta1.Coin
}

func (x *_TotalRestakedAssets_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_TotalRestakedAssets_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_TotalRestakedAssets_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_TotalRestakedAssets_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_TotalRestakedAssets_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_TotalRestakedAssets_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_TotalRestakedAssets_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_TotalRestakedAssets_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_TotalRestakedAssets       protoreflect.MessageDescriptor
	fd_TotalRestakedAssets_coins protoreflect.FieldDescriptor
)

func init() {
	file_milkyway_restaking_v1_models_proto_init()
	md_TotalRestakedAssets = File_milkyway_restaking_v1_models_proto.Messages().ByName("TotalRestakedAssets")
	fd_TotalRestakedAssets_coins = md_TotalRestakedAssets.Fields().ByName("coins")
}

var _ protoreflect.Message = (*fastReflection_TotalRestakedAssets)(nil)

type fastReflection_TotalRestakedAssets TotalRestakedAssets

func (x *TotalRestakedAssets) ProtoReflect() protoreflect.Message {
	return (*fastReflection_TotalRestakedAssets)(x)
}

func (x *TotalRestakedAssets) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_TotalRestakedAssets_messageType fastReflection_TotalRestakedAssets_messageType
var _ protoreflect.MessageType = fastReflection_TotalRestakedAssets_messageType{}

type fastReflection_TotalRestakedAssets_messageType struct{}

func (x fastReflection_TotalRestakedAssets_messageType) Zero() protoreflect.Message {
	return (*fastReflection_TotalRestakedAssets)(nil)
}
func (x fastReflection_TotalRestakedAssets_messageType) New() protoreflect.Message {
	return new(fastReflection_TotalRestakedAssets)
}
func (x fastReflection_TotalRestakedAssets_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_TotalRestakedAssets
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_TotalRestakedAssets) Descriptor() protoreflect.MessageDescriptor {
	return md_TotalRestakedAssets
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_TotalRestakedAssets) Type() protoreflect.MessageType {
	return _fastReflection_TotalRestakedAssets_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_TotalRestakedAssets) New() protoreflect.Message {
	return new(fastReflection_TotalRestakedAssets)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_TotalRestakedAssets) Interface() protoreflect.ProtoMessage {
	return (*TotalRestakedAssets)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_TotalRestakedAssets) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Coins) != 0 {
		value := protoreflect.ValueOfList(&_TotalRestakedAssets_1_list{list: &x.Coins})
		if !f(fd_TotalRestakedAssets_coins, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_TotalRestakedAssets) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "milkyway.restaking.v1.TotalRestakedAssets.coins":
		return len(x.Coins) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.TotalRestakedAssets"))
		}
		panic(fmt.Errorf("message milkyway.restaking.v1.TotalRestakedAssets does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TotalRestakedAssets) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "milkyway.restaking.v1.TotalRestakedAssets.coins":
		x.Coins = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_TotalRestakedAssets) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "milkyway.restaking.v1.TotalRestakedAssets.coins":
		if len(x.Coins) == 0 {
			return protoreflect.ValueOfList(&_TotalRestakedAssets_1_list{})
		}
		listValue := &_TotalRestakedAssets_1_list{list: &x.Coins}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.TotalRestakedAssets"))
		}
		panic(fmt.Errorf("message milkyway.restaking.v1.TotalRestakedAssets does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TotalRestakedAssets) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "milkyway.restaking.v1.TotalRestakedAssets.coins":
		lv := value.List()
		clv := lv.(*_TotalRestakedAssets_1_list)
		x.Coins = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.TotalRestakedAssets"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TotalRestakedAssets) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.restaking.v1.TotalRestakedAssets.coins":
		if x.Coins == nil {
			x.Coins = []*v1beta1.Coin{}
		}
		value := &_TotalRestakedAssets_1_list{list: &x.Coins}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.TotalRestakedAssets"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_TotalRestakedAssets) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "milkyway.restaking.v1.TotalRestakedAssets.coins":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_TotalRestakedAssets_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: milkyway.restaking.v1.TotalRestakedAssets"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_TotalRestakedAssets) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in milkyway.restaking.v1.TotalRestakedAssets", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_TotalRestakedAssets) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TotalRestakedAssets) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_TotalRestakedAssets) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_TotalRestakedAssets) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*TotalRestakedAssets)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: TotalRestakedAssets: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: TotalRestakedAssets: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
type TotalRestakedAssets struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TotalRestakedAssets) Reset() {
	*x = TotalRestakedAssets{}
	if protoimpl.UnsafeEnabled {
		mi := &file_milkyway_restaking_v1_models_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *TotalRestakedAssets) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TotalRestakedAssets) ProtoMessage() {}

// Deprecated: Use TotalRestakedAssets.ProtoReflect.Descriptor instead.
func (*TotalRestakedAssets) Descriptor() ([]byte, []int) {
	return file_milkyway_restaking_v1_models_proto_rawDescGZIP(), []int{7}
}

func (x *TotalRestakedAssets) GetCoins() []*v1beta1.Coin {
	if x != nil {
		return x.Coins
	}
	return nil
...
var file_milkyway_restaking_v1_models_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x22, 0x78, 0x0a, 0x13, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x74, 0x61,
	0x6b, 0x65, 0x64, 0x41, 0x73, 0x73, 0x65, 0x74, 0x73, 0x12, 0x61, 0x0a, 0x05, 0x63, 0x6f, 0x69,
	...
	,
...
var file_milkyway_restaking_v1_models_proto_goTypes = []interface{}{
	...
	(*TotalRestakedAssets)(nil),      // 8: milkyway.restaking.v1.TotalRestakedAssets
...
var file_milkyway_restaking_v1_models_proto_depIdxs = []int32{
	...
	10, // 11: milkyway.restaking.v1.TotalRestakedAssets.coins:type_name -> cosmos.base.v1beta1.Coin
...
func file_milkyway_restaking_v1_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_milkyway_restaking_v1_models_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TotalRestakedAssets); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
