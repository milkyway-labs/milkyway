...
const (
	Query_InvestorsRewardRatio_FullMethodName = "/milkyway.investors.v1.Query/InvestorsRewardRatio"
	Query_VestingInvestors_FullMethodName     = "/milkyway.investors.v1.Query/VestingInvestors"
)
...
func (c *queryClient) InvestorsRewardRatio(ctx context.Context, in *QueryInvestorsRewardRatioRequest, opts ...grpc.CallOption) (*QueryInvestorsRewardRatioResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_InvestorsRewardRatio_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VestingInvestors(ctx context.Context, in *QueryVestingInvestorsRequest, opts ...grpc.CallOption) (*QueryVestingInvestorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VestingInvestors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) InvestorsRewardRatio(context.Context, *QueryInvestorsRewardRatioRequest) (*QueryInvestorsRewardRatioResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InvestorsRewardRatio not implemented")
}
func (UnimplementedQueryServer) VestingInvestors(context.Context, *QueryVestingInvestorsRequest) (*QueryVestingInvestorsResponse, error) {
...
func _Query_InvestorsRewardRatio_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_InvestorsRewardRatio_FullMethodName,
	}
...
func _Query_VestingInvestors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VestingInvestors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
