...
const (
	Query_EpochInfos_FullMethodName   = "/stride.epochs.Query/EpochInfos"
	Query_CurrentEpoch_FullMethodName = "/stride.epochs.Query/CurrentEpoch"
	Query_EpochInfo_FullMethodName    = "/stride.epochs.Query/EpochInfo"
)
