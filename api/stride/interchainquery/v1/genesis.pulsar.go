...
func init() {
	file_stride_interchainquery_v1_genesis_proto_init()
	md_Query = File_stride_interchainquery_v1_genesis_proto.Messages().ByName("Query")
...
func (x *Query) slowProtoReflect() protoreflect.Message {
	mi := &file_stride_interchainquery_v1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_Query) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "stride.interchainquery.v1.Query.id":
		return x.Id != ""
	case "stride.interchainquery.v1.Query.connection_id":
		return x.ConnectionId != ""
	case "stride.interchainquery.v1.Query.chain_id":
		return x.ChainId != ""
	case "stride.interchainquery.v1.Query.query_type":
		return x.QueryType != ""
	case "stride.interchainquery.v1.Query.request_data":
		return len(x.RequestData) != 0
	case "stride.interchainquery.v1.Query.callback_module":
		return x.CallbackModule != ""
	case "stride.interchainquery.v1.Query.callback_id":
		return x.CallbackId != ""
	case "stride.interchainquery.v1.Query.callback_data":
		return len(x.CallbackData) != 0
	case "stride.interchainquery.v1.Query.timeout_policy":
		return x.TimeoutPolicy != 0
	case "stride.interchainquery.v1.Query.timeout_duration":
		return x.TimeoutDuration != nil
	case "stride.interchainquery.v1.Query.timeout_timestamp":
		return x.TimeoutTimestamp != uint64(0)
	case "stride.interchainquery.v1.Query.request_sent":
		return x.RequestSent != false
	case "stride.interchainquery.v1.Query.submission_height":
		return x.SubmissionHeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stride.interchainquery.v1.Query"))
		}
		panic(fmt.Errorf("message stride.interchainquery.v1.Query does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Query) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message stride.interchainquery.v1.Query does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Query) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "stride.interchainquery.v1.Query.id":
		panic(fmt.Errorf("field id of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.connection_id":
		panic(fmt.Errorf("field connection_id of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.chain_id":
		panic(fmt.Errorf("field chain_id of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.query_type":
		panic(fmt.Errorf("field query_type of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.request_data":
		panic(fmt.Errorf("field request_data of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.callback_module":
		panic(fmt.Errorf("field callback_module of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.callback_id":
		panic(fmt.Errorf("field callback_id of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.callback_data":
		panic(fmt.Errorf("field callback_data of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.timeout_policy":
		panic(fmt.Errorf("field timeout_policy of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.timeout_timestamp":
		panic(fmt.Errorf("field timeout_timestamp of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.request_sent":
		panic(fmt.Errorf("field request_sent of message stride.interchainquery.v1.Query is not mutable"))
	case "stride.interchainquery.v1.Query.submission_height":
		panic(fmt.Errorf("field submission_height of message stride.interchainquery.v1.Query is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stride.interchainquery.v1.Query"))
		}
...
func (x *fastReflection_Query) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in stride.interchainquery.v1.Query", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_stride_interchainquery_v1_genesis_proto_init()
	md_DataPoint = File_stride_interchainquery_v1_genesis_proto.Messages().ByName("DataPoint")
...
func (x *DataPoint) slowProtoReflect() protoreflect.Message {
	mi := &file_stride_interchainquery_v1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_DataPoint) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "stride.interchainquery.v1.DataPoint.id":
		return x.Id != ""
	case "stride.interchainquery.v1.DataPoint.remote_height":
		return x.RemoteHeight != ""
	case "stride.interchainquery.v1.DataPoint.local_height":
		return x.LocalHeight != ""
	case "stride.interchainquery.v1.DataPoint.value":
		return len(x.Value) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stride.interchainquery.v1.DataPoint"))
		}
		panic(fmt.Errorf("message stride.interchainquery.v1.DataPoint does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DataPoint) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message stride.interchainquery.v1.DataPoint does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DataPoint) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "stride.interchainquery.v1.DataPoint.id":
		panic(fmt.Errorf("field id of message stride.interchainquery.v1.DataPoint is not mutable"))
	case "stride.interchainquery.v1.DataPoint.remote_height":
		panic(fmt.Errorf("field remote_height of message stride.interchainquery.v1.DataPoint is not mutable"))
	case "stride.interchainquery.v1.DataPoint.local_height":
		panic(fmt.Errorf("field local_height of message stride.interchainquery.v1.DataPoint is not mutable"))
	case "stride.interchainquery.v1.DataPoint.value":
		panic(fmt.Errorf("field value of message stride.interchainquery.v1.DataPoint is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stride.interchainquery.v1.DataPoint"))
		}
...
func (x *fastReflection_DataPoint) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in stride.interchainquery.v1.DataPoint", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_stride_interchainquery_v1_genesis_proto_init()
	md_GenesisState = File_stride_interchainquery_v1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_stride_interchainquery_v1_genesis_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "stride.interchainquery.v1.GenesisState.queries":
		return len(x.Queries) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: stride.interchainquery.v1.GenesisState"))
		}
		panic(fmt.Errorf("message stride.interchainquery.v1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message stride.interchainquery.v1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in stride.interchainquery.v1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (TimeoutPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_stride_interchainquery_v1_genesis_proto_enumTypes[0].Descriptor()
}

func (TimeoutPolicy) Type() protoreflect.EnumType {
	return &file_stride_interchainquery_v1_genesis_proto_enumTypes[0]
}
...
func (TimeoutPolicy) EnumDescriptor() ([]byte, []int) {
	return file_stride_interchainquery_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*DataPoint) Descriptor() ([]byte, []int) {
	return file_stride_interchainquery_v1_genesis_proto_rawDescGZIP(), []int{1}
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_stride_interchainquery_v1_genesis_proto_rawDescGZIP(), []int{2}
}
...
var file_stride_interchainquery_v1_genesis_proto_rawDesc = []byte{
	0x0a, 0x27, 0x73, 0x74, 0x72, 0x69, 0x64, 0x65, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x63, 0x68,
	0x61, 0x69, 0x6e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x6e, 0x65,
	0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x73, 0x74, 0x72, 0x69, 0x64,
	0x65, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x71, 0x75, 0x65, 0x72,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa6, 0x04, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
}

var (
	file_stride_interchainquery_v1_genesis_proto_rawDescOnce sync.Once
	file_stride_interchainquery_v1_genesis_proto_rawDescData = file_stride_interchainquery_v1_genesis_proto_rawDesc
)

func file_stride_interchainquery_v1_genesis_proto_rawDescGZIP() []byte {
	file_stride_interchainquery_v1_genesis_proto_rawDescOnce.Do(func() {
		file_stride_interchainquery_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_stride_interchainquery_v1_genesis_proto_rawDescData)
	})
	return file_stride_interchainquery_v1_genesis_proto_rawDescData
}

var file_stride_interchainquery_v1_genesis_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_stride_interchainquery_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_stride_interchainquery_v1_genesis_proto_goTypes = []interface{}{
	(TimeoutPolicy)(0),          // 0: stride.interchainquery.v1.TimeoutPolicy
	(*Query)(nil),               // 1: stride.interchainquery.v1.Query
	(*DataPoint)(nil),           // 2: stride.interchainquery.v1.DataPoint
	(*GenesisState)(nil),        // 3: stride.interchainquery.v1.GenesisState
	(*durationpb.Duration)(nil), // 4: google.protobuf.Duration
}
var file_stride_interchainquery_v1_genesis_proto_depIdxs = []int32{
	0, // 0: stride.interchainquery.v1.Query.timeout_policy:type_name -> stride.interchainquery.v1.TimeoutPolicy
	4, // 1: stride.interchainquery.v1.Query.timeout_duration:type_name -> google.protobuf.Duration
	1, // 2: stride.interchainquery.v1.GenesisState.queries:type_name -> stride.interchainquery.v1.Query
...
func init() { file_stride_interchainquery_v1_genesis_proto_init() }
func file_stride_interchainquery_v1_genesis_proto_init() {
	if File_stride_interchainquery_v1_genesis_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_stride_interchainquery_v1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Query); i {
			case 0:
				return &v.state
			case 1:
		...
		file_stride_interchainquery_v1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_stride_interchainquery_v1_genesis_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_stride_interchainquery_v1_genesis_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_stride_interchainquery_v1_genesis_proto_goTypes,
		DependencyIndexes: file_stride_interchainquery_v1_genesis_proto_depIdxs,
		EnumInfos:         file_stride_interchainquery_v1_genesis_proto_enumTypes,
		MessageInfos:      file_stride_interchainquery_v1_genesis_proto_msgTypes,
	}.Build()
	File_stride_interchainquery_v1_genesis_proto = out.File
	file_stride_interchainquery_v1_genesis_proto_rawDesc = nil
	file_stride_interchainquery_v1_genesis_proto_goTypes = nil
	file_stride_interchainquery_v1_genesis_proto_depIdxs = nil
}
