...
type UserPreferences struct {
	// TrustAllServices tells whether the user trusts all services (both
	// accredited and non-accredited) present on the platform.
	TrustAllServices bool `protobuf:"varint,1,opt,name=trust_all_services,json=trustAllServices,proto3" json:"trust_all_services,omitempty"`
	// TrustAllAccreditedServices tells whether the user trusts all accredited
	// services present on the platform.
	TrustAllAccreditedServices bool `protobuf:"varint,2,opt,name=trust_all_accredited_services,json=trustAllAccreditedServices,proto3" json:"trust_all_accredited_services,omitempty"`
...
func (m *UserPreferences) GetTrustAllServices() bool {
	if m != nil {
		return m.TrustAllServices
	}
	return false
}

func (m *UserPreferences) GetTrustAllAccreditedServices() bool {
	if m != nil {
		return m.TrustAllAccreditedServices
	}
	return false
}
...
var fileDescriptor_86f4cd48423b1e2f = []byte{
	...
	,
}
...
func (m *UserPreferences) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TrustAllAccreditedServices {
		i--
		if m.TrustAllAccreditedServices {
			dAtA[i] = 1
		} else {
...
func (m *UserPreferences) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TrustAllServices", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TrustAllServices = bool(v != 0)
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TrustAllAccreditedServices", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TrustAllAccreditedServices = bool(v != 0)
		case 3:
			if wireType == 0 {
				var v uint32
				for shift := uint(0); ; shift += 7 {
