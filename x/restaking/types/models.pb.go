...
func (m *TotalRestakedAssets) Reset()         { *m = TotalRestakedAssets{} }
func (m *TotalRestakedAssets) String() string { return proto.CompactTextString(m) }
...
func (m *TotalRestakedAssets) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TotalRestakedAssets) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TotalRestakedAssets.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TotalRestakedAssets) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TotalRestakedAssets.Merge(m, src)
}
func (m *TotalRestakedAssets) XXX_Size() int {
	return m.Size()
}
func (m *TotalRestakedAssets) XXX_DiscardUnknown() {
	xxx_messageInfo_TotalRestakedAssets.DiscardUnknown(m)
}

var xxx_messageInfo_TotalRestakedAssets proto.InternalMessageInfo

func (m *TotalRestakedAssets) GetCoins() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Coins
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TotalRestakedAssets)(nil), "milkyway.restaking.v1.TotalRestakedAssets")
}
...
var fileDescriptor_86f4cd48423b1e2f = []byte{
	...
	,
}
...
func (m *TotalRestakedAssets) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TotalRestakedAssets) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TotalRestakedAssets) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TotalRestakedAssets) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TotalRestakedAssets) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TotalRestakedAssets: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TotalRestakedAssets: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
