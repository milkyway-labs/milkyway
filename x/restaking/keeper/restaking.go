...
func (k *Keeper) PerformDelegation(ctx sdk.Context, data types.DelegationData) (sdkmath.LegacyDec, error) {
	// Get the data
	...
	if found {
		...
		delegation = data.BuildDelegation(receiver.GetID(), delegator, sdkmath.LegacyZeroDec())
