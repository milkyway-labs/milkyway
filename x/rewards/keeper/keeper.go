...
func NewKeeper(
	...
	k := &Keeper{
		...
		NextRewardsPlanID: collections.NewItem(
			sb,
			types.NextRewardsPlanIDKey,
			"next_rewards_plan_id",
			collections.Uint64Value,
		),
		RewardsPlans: collections.NewMap(
			sb,
			types.RewardsPlanKeyPrefix,
			"rewards_plans",
			collections.Uint64Key,
			codec.CollValue[types.RewardsPlan](cdc),
		),
		LastRewardsAllocationTime: collections.NewItem(
			sb,
			types.LastRewardsAllocationTimeKey,
			"last_rewards_allocation_time",
			codec.CollValue[gogotypes.Timestamp](cdc),
		),
		DelegatorWithdrawAddrs: collections.NewMap(
			sb,
			types.DelegatorWithdrawAddrKeyPrefix,
			"delegator_withdraw_addrs",
			sdk.AccAddressKey,
			collcodec.KeyToValueCodec(sdk.AccAddressKey),
		),
		PoolDelegatorStartingInfos: collections.NewMap(
			sb,
			types.PoolDelegatorStartingInfoKeyPrefix,
			"pool_delegator_starting_infos",
		...
		PoolHistoricalRewards: collections.NewMap(
			sb,
			types.PoolHistoricalRewardsKeyPrefix,
		...
		PoolCurrentRewards: collections.NewMap(
			sb,
			types.PoolCurrentRewardsKeyPrefix,
		...
		PoolOutstandingRewards: collections.NewMap(
			sb,
			types.PoolOutstandingRewardsKeyPrefix,
		...
		OperatorAccumulatedCommissions: collections.NewMap(
			sb,
			types.OperatorAccumulatedCommissionKeyPrefix,
			"operator_accumulated_commissions",
			collections.Uint32Key,
			codec.CollValue[types.AccumulatedCommission](cdc),
		),
		OperatorDelegatorStartingInfos: collections.NewMap(
			sb,
			types.OperatorDelegatorStartingInfoKeyPrefix,
			"operator_delegator_starting_infos",
			collections.PairKeyCodec(collections.Uint32Key, sdk.AccAddressKey),
			codec.CollValue[types.DelegatorStartingInfo](cdc),
		),
		OperatorHistoricalRewards: collections.NewMap(
			sb,
			types.OperatorHistoricalRewardsKeyPrefix,
			"operator_historical_rewards",
			collections.PairKeyCodec(collections.Uint32Key, collections.Uint64Key),
			codec.CollValue[types.HistoricalRewards](cdc),
		),
		OperatorCurrentRewards: collections.NewMap(
			sb,
			types.OperatorCurrentRewardsKeyPrefix,
			"operator_current_rewards",
			collections.Uint32Key,
			codec.CollValue[types.CurrentRewards](cdc),
		),
		OperatorOutstandingRewards: collections.NewMap(
			sb,
			types.OperatorOutstandingRewardsKeyPrefix,
			"operator_outstanding_rewards",
			collections.Uint32Key,
			codec.CollValue[types.OutstandingRewards](cdc),
		),
		ServiceDelegatorStartingInfos: collections.NewMap(
			sb,
			types.ServiceDelegatorStartingInfoKeyPrefix,
			"service_delegator_starting_infos",
			collections.PairKeyCodec(collections.Uint32Key, sdk.AccAddressKey),
			codec.CollValue[types.DelegatorStartingInfo](cdc),
		),
		ServiceHistoricalRewards: collections.NewMap(
			sb,
			types.ServiceHistoricalRewardsKeyPrefix,
			"service_historical_rewards",
			collections.PairKeyCodec(collections.Uint32Key, collections.Uint64Key),
			codec.CollValue[types.HistoricalRewards](cdc),
		),
		ServiceCurrentRewards: collections.NewMap(
			sb,
			types.ServiceCurrentRewardsKeyPrefix,
			"service_current_rewards",
			collections.Uint32Key,
			codec.CollValue[types.CurrentRewards](cdc),
		),
		ServiceOutstandingRewards: collections.NewMap(
			sb,
			types.ServiceOutstandingRewardsKeyPrefix,
			"service_outstanding_rewards",
			collections.Uint32Key,
			codec.CollValue[types.OutstandingRewards](cdc),
		),
