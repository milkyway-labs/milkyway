...
func (h *Keeper) SendRestrictionFn(
...
func (h *Keeper) isRestakingModule(ctx sdk.Context, account sdk.AccAddress) bool {
...
func (h *Keeper) isCoveredByInsuranceFund(
	ctx sdk.Context,
	user sdk.AccAddress,
...
func (h *Keeper) getUserDelegateAmount(ctx sdk.Context, user sdk.AccAddress, denom string) (math.LegacyDec, error) {
