...
func (k *Keeper) RestakeRestrictionFn(ctx sdk.Context, restakerAddress string, amount sdk.Coins, target restakingtypes.DelegationTarget) error {
	...
	accAddr, err := sdk.AccAddressFromBech32(restakerAddress)
	if err != nil {
		return err
	}
	userInsuranceFund, err := k.GetUserInsuranceFund(ctx, accAddr)
	if err != nil {
		return nil
	}
