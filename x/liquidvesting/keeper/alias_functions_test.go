	...
	testCases := []struct {
		...
		},
		{
			...
			setup: func(ctx sdk.Context) {
				...
				// Fund the account
				suite.fundAccountInsuranceFund(ctx, "cosmos1pgzph9rze2j2xxavx4n7pdhxlkgsq7raqh8hre", sdk.NewCoins(sdk.NewInt64Coin("stake", 20)))
				suite.mintVestedRepresentation("cosmos1pgzph9rze2j2xxavx4n7pdhxlkgsq7raqh8hre", sdk.NewCoins(sdk.NewInt64Coin("stake", 1000)))
