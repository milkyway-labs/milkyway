...
func (k *Keeper) GetAllUserRestakedVestedRepresentations(ctx sdk.Context, userAddress string) (sdk.DecCoins, error) {
...
func (k *Keeper) GetAllUserUnbondingVestedRepresentations(ctx sdk.Context, userAddress string) sdk.Coins {
	vestedRepresentations := sdk.NewCoins()

	userUndelegations := k.restakingKeeper.GetAllUnbondingDelegations(ctx)
...
func (k *Keeper) GetAllUserActiveVestedRepresentations(ctx sdk.Context, userAddress string) (sdk.DecCoins, error) {
