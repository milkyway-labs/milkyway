...
import (
	...
	types1 "github.com/milkyway-labs/milkyway/x/records/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type ReinvestCallback struct {
	ReinvestAmount types.Coin `protobuf:"bytes,1,opt,name=reinvest_amount,json=reinvestAmount,proto3,castrepeated=cosmossdk.io/math.Coin" json:"reinvest_amount"`
...
type DelegatorSharesQueryCallback struct {
	...
	InitialValidatorDelegation cosmossdk_io_math.Int `protobuf:"bytes,1,opt,name=initial_validator_delegation,json=initialValidatorDelegation,proto3,customtype=cosmossdk.io/math.Int" json:"initial_validator_delegation"`
}
...
var fileDescriptor_f41c99b09b96a5ac = []byte{
	...
	,
}
