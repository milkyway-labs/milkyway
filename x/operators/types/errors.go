...
var (
	...
	ErrInvalidExecuteMessagesSigner = errors.Register(ModuleName, 6, "expected operator as only signer for executing messages")
	ErrInvalidExecuteMsg            = errors.Register(ModuleName, 7, "invalid execute message")
	ErrUnroutableExecuteMsg         = errors.Register(ModuleName, 8, "unroutable execute message")
)
